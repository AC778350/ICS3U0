...
print("I will find the cube's inner diagonal for any edge length!") # introduces and explains the purpose of the program to the user
m = input("Please enter the edge length of your cube:") # has the user input the side length of the cube 
m = float(m)
  ...
  if c >= 10:
    ...
    if c>= 5:
      ...
      if c >= 1:
        p = c/1
        p = int(p)
print("Your change under a dollar is", q, "quarters,", d, "dimes,", n, "nickels and", p, "pennies.") # lets the user know how many of each coin they need
